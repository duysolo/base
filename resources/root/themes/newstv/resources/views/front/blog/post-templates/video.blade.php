                    ...
                    <div class="main-box-content">
                        ...
                        <div class="article-content">
                            <div class="embed-responsive embed-responsive-16by9 mb30">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{{ parse_youtube_embedded(get_field($object->id, WEBED_BLOG_POSTS, 'youtube_video_url')) }}" frameborder="0"
